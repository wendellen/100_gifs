...
makeStar(3, 10, 'Black', 2000).play()
makeStar(3, 20, 'Black', 2100).play()
makeStar(3, 30, 'Black', 2200).play()
makeStar(3, 40, 'Black', 2300).play()
makeStar(3, 50, 'Black', 2400).play()
makeStar(3, 60, 'Black', 2500).play()
makeStar(3, 70, 'Black', 2600).play()
makeStar(3, 80, 'Black', 2700).play()
makeStar(3, 90, 'Black', 2800).play()
makeStar(3, 100, 'Black', 2900).play()
