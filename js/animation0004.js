...
makeStar(3, 10, 'mistyrose', 2000).play()
makeStar(3, 20, 'lightpink', 2100).play()
makeStar(3, 30, 'hotpink', 2200).play()
makeStar(3, 40, 'powderblue', 2300).play()
makeStar(3, 50, 'plum', 2400).play()
makeStar(3, 60, 'mistyrose', 2500).play()
makeStar(3, 70, 'lightpink', 2600).play()
makeStar(3, 80, 'hotpink', 2700).play()
makeStar(3, 90, 'powderblue', 2800).play()
makeStar(3, 100, 'plum', 2900).play()
